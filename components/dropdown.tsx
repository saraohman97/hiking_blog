...
const DropDown = () => {
  ...
  return (
    <div className="relative group">
      ...
      <div className="invisible group-hover:visible absolute top-10 right-0 border bg-white min-w-40 rounded text-sm transition-all ease-in-out duration-300">
        <div className="font-bold border-b p-2">Inställningar</div>
        <div className="flex items-center gap-2 p-2 hover:bg-green-50 cursor-pointer">
          <BsMoon /> Mörk Skärm
        </div>
        <div
          onClick={copy}
